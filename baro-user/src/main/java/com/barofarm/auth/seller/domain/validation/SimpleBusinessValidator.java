package com.barofarm.auth.seller.domain.validation;

import static com.barofarm.auth.seller.exception.ValidationErrorCode.DUPLICATE_BUSINESS_NO;
import static com.barofarm.auth.seller.exception.ValidationErrorCode.INVALID_BUSINESS_NO_FORMAT;
import static com.barofarm.auth.seller.exception.ValidationErrorCode.REQUIRED_FIELD_MISSING;

import com.barofarm.auth.seller.exception.SellerErrorCode;
