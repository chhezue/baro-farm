...
import static com.barofarm.auth.seller.exception.SellerErrorCode.SELLER_NOT_FOUND;

import com.barofarm.auth.seller.domain.Seller;
import com.barofarm.auth.seller.domain.SellerRepository;
import com.barofarm.auth.seller.domain.validation.BusinessValidator;
import com.barofarm.auth.seller.exception.FeignErrorCode;
import com.barofarm.auth.seller.exception.ValidationErrorCode;
import com.barofarm.auth.seller.infrastructure.feign.AuthClient;
import com.barofarm.auth.seller.presentation.dto.SellerApplyRequestDto;
import com.barofarm.auth.seller.presentation.dto.SellerInfoDto;
