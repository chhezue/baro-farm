package com.barofarm.payment.deposit.exception;
...
public enum DepositErrorCode implements BaseErrorCode {
    ...
    DEPOSIT_CHARGE_INVALID_STATUS(HttpStatus.CONFLICT, "해당 상태에서는 예치금 충전 요청을 처리할 수 없습니다."),
    INSUFFICIENT_DEPOSIT_BALANCE(HttpStatus.BAD_REQUEST, "예치금 잔액이 부족합니다."),
    DEPOSIT_ACCESS_DENIED(HttpStatus.FORBIDDEN, "다른 사용자의 예치금 계정에 접근할 수 없습니다."),
